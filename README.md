...
## Architecture
EV Stations (Docker + Containernet)
→ Telemetry Generation (Python)
→ Synchronization Pipeline (Bash)
→ JSON Storage
...
source_code/
  Smart EV simulation, pipeline, API integration, and React dashboard
